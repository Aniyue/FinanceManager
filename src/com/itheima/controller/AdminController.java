...
public class AdminController {
	...
	public String login( Admin admin, Model model, HttpSession session, HttpServletRequest request) {
		...
		if(ad!=null && ad.getA_id()==1){
			session.setAttribute("ad", ad);
			return "homepage2";//企业拥有者
		}
		else if(ad!=null && ad.getA_id()==2){
			session.setAttribute("ad", ad);
			return "homepage";//财务人员
		}
		else if(ad!=null && ad.getA_id()!=1 && ad.getA_id()!=2){
			session.setAttribute("ad", ad);
			return "homepage3";//普通员工
		}
