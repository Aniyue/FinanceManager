...
<div class="x-body">
    ...
    <xblock>
        <button id="addStudnetBtn" class="layui-btn layui-btn-normal"> <i class="layui-icon layui-icon-add-circle"></i>添加</button>
        <button class="layui-btn " lay-filter="toolbarDemo" lay-submit=""><i class="layui-icon layui-icon-download-circle"> </i>导出</button>
